...
export default function ManagerLayout({ children }: { children: React.ReactNode }) {
  ...
  const navLinks = [
    { label: "Project control", href: "/manager" },
    { label: "Evidence verification", href: "/manager/evidence" },
    { label: "Schedule", href: "/manager/schedule" },
    { label: "Work breakdown", href: "/manager/breakdown" },
    { label: "Activity", href: "/manager/activity" },
    { label: "Reports", href: "/manager/reports" },
    { label: "Documents", href: "/manager/documents" },
    { label: "Alerts", href: "/manager/alerts", badge: 4 },
  ];
      ...
      <aside className="w-64 bg-[#1b1916] text-gray-400 flex flex-col justify-between shrink-0 shadow-xl z-25">
        <div>
          <div className="p-6 border-b border-gray-800/60">
            ...
            <p className="text-[9px] tracking-[0.2em] text-gray-500 mt-1 uppercase font-semibold">Project Manager</p>
          </div>
        ...
        <div className="p-5 border-t border-gray-800/60 bg-[#141210] flex items-center space-x-3">
          ...
          <div className="overflow-hidden">
            <p className="text-xs font-bold text-white truncate">Project Manager</p>
            <p className="text-[10px] text-gray-500 truncate">Control Room 15</p>
          </div>
        </div>
      </aside>
